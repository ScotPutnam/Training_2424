...
/**
 * Handles payment processing for the e-commerce platform. This is the class
 * under test for the service-layer exercise.
 *
 * All five collaborators are supplied through the constructor so your tests
 * can inject Mockito mocks.
 */
